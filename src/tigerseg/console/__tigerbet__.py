...
def main():
    ...
    default_model = 'mprage_v0002_bet_kuo'
    ...
    parser.add_argument('--modelname', default=default_model, type=str, help='specifies the modelname')
    ...
    segment.apply_files(model_name=args.modelname,
