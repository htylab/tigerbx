...
from tigerseg.unet3d.utils.utils import read_image, get_input_image, walk_input_dir
...
def onnx_apply(input=None,output=None,modelpath=os.getcwd(),only_CPU=False,seg_mode=0,mri_type='1'):
    ...
    if seg_mode==0:
        ...
        model_file = os.path.join(modelpath, "brats2021model.onnx")
        config['model_file'] = model_file
        model_url = 'https://github.com/JENNSHIUAN/myfirstpost/releases/download/0.0.1/unet_model.onnx'
        example_url = 'https://github.com/JENNSHIUAN/myfirstpost/releases/download/0.0.1/example.nii.gz'
